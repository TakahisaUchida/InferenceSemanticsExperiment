...
nlp = spacy.load('../pretrainedData/glove-twit-200')
...
#data output file
f = open('McKoon_experiment-twitter.csv', 'w')
...
for i in range(N):
    ...
    # create the vector average of the discourse words
    # this is where we would want to send the whole discourse_words_1 string to BERT
    # probably need to correctly format the input to BERT
