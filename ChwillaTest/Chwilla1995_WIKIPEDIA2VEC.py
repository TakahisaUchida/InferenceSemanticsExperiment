...
fig.tight_layout()
plt.savefig('pairs-chwilla1995-WIKIPEDIA2VEC'+pretrained_model+'.png')
plt.show()

print(stats.ttest_ind(related_data,unrelated_data))
with open('ttest_ind-WIKIPEDIA2VEC-'+pretrained_model+'.csv', 'w') as f_ttest_ind:
...
# Show the graph
# plt.savefig('ChwillaPairsHistogram-WIKIPEDIA2VEC-'+pretrained_model+'.png')
plt.show()
...
# Show the graph
plt.savefig('ChwillaPairsBOXandHistogram-WIKIPEDIA2VEC-'+pretrained_model+'.png')
plt.show()
