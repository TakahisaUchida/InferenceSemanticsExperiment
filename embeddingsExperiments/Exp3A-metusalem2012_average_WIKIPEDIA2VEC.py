...
#wiki2vec = Wikipedia2Vec.load('C:/Users/PeterDell/Google Drive/GoogleWIP/People/Uchida/ExpDuplication/word2vec/enwiki_20180420_100d.pkl')

#pretrained_model = 'enwiki_20180420_100d'
#pretrained_model = 'enwiki_20180420_300d'
#pretrained_model = 'enwiki_20180420_500d'
#pretrained_model = 'enwiki_20180420_nolg_100d'
#pretrained_model = 'enwiki_20180420_nolg_300d'
#pretrained_model = 'enwiki_20180420_nolg_500d'
#pretrained_model = 'enwiki_20180420_win10_100d'
#pretrained_model = 'enwiki_20180420_win10_300d'
pretrained_model = 'enwiki_20180420_win10_500d'
wiki2vec = Wikipedia2Vec.load('../pretrainedData/'+pretrained_model+'.pkl')
...
vectors = np.empty([N,500])

f = open('metusalem2012_experiment-'+pretrained_model+'.csv', 'w')
...
ax.set_xticklabels(['Sent-Expect', 'Sent-Relat', 'Sent-Unrel', 'Disc-Expect', 'Disc-Relat', 'Disc-Unrel'])
fig.tight_layout()
plt.savefig('Metusalem-72-avg-'+pretrained_model+'.png')
plt.show()
...
plt.savefig('Metusalem-72-avg-distributions-'+pretrained_model+'.png')
plt.show()
